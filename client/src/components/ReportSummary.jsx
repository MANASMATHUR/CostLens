...
export function ReportSummary({ report, activePillar = "infra" }) {
  ...
  const pillarLabel = pillar === "infra" ? "Their Cost" : pillar === "build" ? "Build Cost" : pillar === "buyer" ? "Your Cost" : pillar === "competitors" ? "Competitors" : "Risk";
  ...
  const checklist = checklistPillars.map((p) => {
    ...
    return {
      pillar: p,
      label: p === "infra" ? "Their Cost" : p === "build" ? "Build Cost" : p === "buyer" ? "Your Cost" : p === "competitors" ? "Competitors" : "Risk",
          ...
          : pillar === "risk"
            ...
            : pillar === "competitors"
              ? report.competitorAnalysis?.competitors?.length > 0
                ? `Competitors Identified: ${report.competitorAnalysis.competitors.length}`
                : null
              : null;
